...
from fcos_core.modeling.discriminator import FCOSDiscriminator, FCOS_KTNet
...
def train(cfg, local_rank, distributed):
    ...
    if cfg.MODEL.ADV.USE_KTNET:
        if cfg.MODEL.ADV.USE_DIS_P7:
            dis_P7_KTNet = FCOS_KTNet(
                num_convs=cfg.MODEL.ADV.CA_DIS_P7_NUM_CONVS,
                num_classes=cfg.MODEL.ADV.NUM_CLASSES).to(device)
        if cfg.MODEL.ADV.USE_DIS_P6:
            dis_P6_KTNet = FCOS_KTNet(
                num_convs=cfg.MODEL.ADV.CA_DIS_P6_NUM_CONVS,
                num_classes=cfg.MODEL.ADV.NUM_CLASSES).to(device)
        if cfg.MODEL.ADV.USE_DIS_P5:
            dis_P5_KTNet = FCOS_KTNet(
                num_convs=cfg.MODEL.ADV.CA_DIS_P5_NUM_CONVS,
                num_classes=cfg.MODEL.ADV.NUM_CLASSES).to(device)
        if cfg.MODEL.ADV.USE_DIS_P4:
            dis_P4_KTNet = FCOS_KTNet(
                num_convs=cfg.MODEL.ADV.CA_DIS_P4_NUM_CONVS,
                num_classes=cfg.MODEL.ADV.NUM_CLASSES).to(device)
        if cfg.MODEL.ADV.USE_DIS_P3:
            dis_P3_KTNet = FCOS_KTNet(
    ...
    if cfg.MODEL.USE_SYNCBN:
        ...
        if cfg.MODEL.ADV.USE_KTNET:
            if cfg.MODEL.ADV.USE_DIS_P7:
                dis_P7_KTNet = torch.nn.SyncBatchNorm.convert_sync_batchnorm(dis_P7_KTNet)
            if cfg.MODEL.ADV.USE_DIS_P6:
                dis_P6_KTNet = torch.nn.SyncBatchNorm.convert_sync_batchnorm(dis_P6_KTNet)
            if cfg.MODEL.ADV.USE_DIS_P5:
                dis_P5_KTNet = torch.nn.SyncBatchNorm.convert_sync_batchnorm(dis_P5_KTNet)
            if cfg.MODEL.ADV.USE_DIS_P4:
                dis_P4_KTNet = torch.nn.SyncBatchNorm.convert_sync_batchnorm(dis_P4_KTNet)
            if cfg.MODEL.ADV.USE_DIS_P3:
                dis_P3_KTNet = torch.nn.SyncBatchNorm.convert_sync_batchnorm(dis_P3_KTNet)
    ...
    if cfg.MODEL.ADV.USE_KTNET:
        if cfg.MODEL.ADV.USE_DIS_P7:
            optimizer["dis_P7_KTNet"] = make_optimizer(cfg, dis_P7_KTNet, name='discriminator')
        if cfg.MODEL.ADV.USE_DIS_P6:
            optimizer["dis_P6_KTNet"] = make_optimizer(cfg, dis_P6_KTNet, name='discriminator')
        if cfg.MODEL.ADV.USE_DIS_P5:
            optimizer["dis_P5_KTNet"] = make_optimizer(cfg, dis_P5_KTNet, name='discriminator')
        if cfg.MODEL.ADV.USE_DIS_P4:
            optimizer["dis_P4_KTNet"] = make_optimizer(cfg, dis_P4_KTNet, name='discriminator')
        if cfg.MODEL.ADV.USE_DIS_P3:
            optimizer["dis_P3_KTNet"] = make_optimizer(cfg, dis_P3_KTNet, name='discriminator')
    ...
    if cfg.MODEL.ADV.USE_KTNET:
        if cfg.MODEL.ADV.USE_DIS_P7:
            scheduler["dis_P7_KTNet"] = make_lr_scheduler(cfg, optimizer["dis_P7_KTNet"], name='discriminator')
        if cfg.MODEL.ADV.USE_DIS_P6:
            scheduler["dis_P6_KTNet"] = make_lr_scheduler(cfg, optimizer["dis_P6_KTNet"], name='discriminator')
        if cfg.MODEL.ADV.USE_DIS_P5:
            scheduler["dis_P5_KTNet"] = make_lr_scheduler(cfg, optimizer["dis_P5_KTNet"], name='discriminator')
        if cfg.MODEL.ADV.USE_DIS_P4:
            scheduler["dis_P4_KTNet"] = make_lr_scheduler(cfg, optimizer["dis_P4_KTNet"], name='discriminator')
        if cfg.MODEL.ADV.USE_DIS_P3:
            scheduler["dis_P3_KTNet"] = make_lr_scheduler(cfg, optimizer["dis_P3_KTNet"], name='discriminator')
    ...
    if distributed:
        ...
        if cfg.MODEL.ADV.USE_KTNET:
            if cfg.MODEL.ADV.USE_DIS_P7:
                dis_P7_KTNet = torch.nn.parallel.DistributedDataParallel(
                    dis_P7_KTNet, device_ids=[local_rank], output_device=local_rank,
                    # this should be removed if we update BatchNorm stats
                    find_unused_parameters=True,
                    broadcast_buffers=False
                )
            if cfg.MODEL.ADV.USE_DIS_P6:
                dis_P6_KTNet = torch.nn.parallel.DistributedDataParallel(
                    dis_P6_KTNet, device_ids=[local_rank], output_device=local_rank,
                    # this should be removed if we update BatchNorm stats
                    find_unused_parameters=True,
                    broadcast_buffers=False
                )
            if cfg.MODEL.ADV.USE_DIS_P5:
                dis_P5_KTNet = torch.nn.parallel.DistributedDataParallel(
                    dis_P5_KTNet, device_ids=[local_rank], output_device=local_rank,
                    # this should be removed if we update BatchNorm stats
                    find_unused_parameters=True,
                    broadcast_buffers=False
                )
            if cfg.MODEL.ADV.USE_DIS_P4:
                dis_P4_KTNet = torch.nn.parallel.DistributedDataParallel(
                    dis_P4_KTNet, device_ids=[local_rank], output_device=local_rank,
                    # this should be removed if we update BatchNorm stats
                    find_unused_parameters=True,
                    broadcast_buffers=False
                )
            if cfg.MODEL.ADV.USE_DIS_P3:
                dis_P3_KTNet = torch.nn.parallel.DistributedDataParallel(
                    dis_P3_KTNet, device_ids=[local_rank], output_device=local_rank,
                    # this should be removed if we update BatchNorm stats
                    find_unused_parameters=True,
                    broadcast_buffers=False
                )
    ...
    if cfg.MODEL.ADV.USE_KTNET:
        if cfg.MODEL.ADV.USE_DIS_P7:
            model["dis_P7_KTNet"] = dis_P7_KTNet
        if cfg.MODEL.ADV.USE_DIS_P6:
            model["dis_P6_KTNet"] = dis_P6_KTNet
        if cfg.MODEL.ADV.USE_DIS_P5:
            model["dis_P5_KTNet"] = dis_P5_KTNet
        if cfg.MODEL.ADV.USE_DIS_P4:
            model["dis_P4_KTNet"] = dis_P4_KTNet
        if cfg.MODEL.ADV.USE_DIS_P3:
            model["dis_P3_KTNet"] = dis_P3_KTNet
    ...
    arguments["use_ktnet"] = cfg.MODEL.ADV.USE_KTNET
